...
public class AmmoDetailsSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("Populate w/ the prefab to be used for the ammo. If multiple prefab are specified then a ramdom prefab from the array will be selected" +
    ...
    #region Tooltip
    [Tooltip("If the ammo should 'charge' briefly before moving then set the time in sec that the ammo is held charging after firing before release")]
    #endregion
    ...
    #endregion
    #region Tooltip
    [Tooltip("SO that defines the parameters for the hit effect")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("The range of the ammo (or ammo patern) in unity units")]
    #endregion
    public float ammoRange = 20f;

    #region Tooltip
    [Tooltip("The rotation speed in degrees per sec of the ammo patern")]
    #endregion
    ...
    #endregion
    #region Tooltip
    [Tooltip("This is the minimum number of ammo that are spawned per shot. A random number of ammo are spawned between the min and amx values")]
    #endregion
    public int ammoSpawnAmountMin = 1;

    #region Tooltip
    [Tooltip("This is the maximum number of ammo that are spawned per shot. A random number of ammo are spawned between the min and amx values")]
    #endregion
    public int ammoSpawnAmountMax = 1;

    #region Tooltip
    [Tooltip("Minimum spawn interval time. The time interval in sec between spawned ammo is a random value between the min and max values specified")]
    #endregion
    public float ammoSpawnIntervalMin = 0f;

    #region Tooltip
    [Tooltip("Maximum spawn interval time. The time interval in sec between spawned ammo is a random value between the min and max values specified")]
    #endregion
    ...
    #endregion
    #region Tooltip
    [Tooltip("Selectef if an ammo trail is required, otherwise deselect. If selected then the rest of the ammo trail values should pe populated")]
    #endregion
    public bool isAmmoTrail = false;

    #region Tooltip
    [Tooltip("Ammo trail lifetime in secs")]
    #endregion
